...
<template>
  <section class="mx-auto container bg-white border border-gray-400 min-h-screen p-12 text-gray-900">
    <div class="flex justify-between">
      <div class="flex flex-col space-y-5 w-1/2s">
        ...
        <textarea v-model="data.sender" name="" id="" cols="30" rows="2" class=""></textarea>
        <div class="flex space-x-2">
          <div class="flex flex-col">
            <span>Bill to</span>
            <textarea v-model="data.billTo" name="" id="" cols="30" rows="2" class=""></textarea>
          </div>
          <div class="flex flex-col">
            <span>Ship to</span>
            <textarea v-model="data.shipTo" name="" id="" cols="30" rows="2" class=""></textarea>
          </div>
        </div>
      </div>
